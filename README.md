...
This code provides a python implementation of the second-order functional connectivity feature and domain adaptation approach described in (url) for Autism classification on the ABIDE dataset.
